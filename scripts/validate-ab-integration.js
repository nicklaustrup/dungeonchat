...
if (envExists) {
  ...
  hasScrollFlags =
    envContent.includes("REACT_APP_USE_AUTO_SCROLL_V2") &&
...
const originalTestsExist = fs.existsSync(
  path.join(__dirname, "../src/hooks/__tests__/useAutoScroll.test.js")
);
const v2TestsExist = fs.existsSync(
  path.join(__dirname, "../src/hooks/__tests__/useAutoScrollV2.test.js")
);
...
if (passedChecks === totalChecks) {
  ...
  console.log(
    "  2. Edit .env.local to enable V2: REACT_APP_USE_AUTO_SCROLL_V2=true"
  );
