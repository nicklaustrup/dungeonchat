...
describe("Reaction Function Call Bugs", () => {
  ...
  test("DESKTOP BUG: Message options menu reactions should call toggleReaction", async () => {
    ...
    const thumbsBtn = menuReactionBtns.find((btn) =>
      btn.textContent.includes("👍")
    );

    console.log(
      "Before menu reaction click - calls:",
      mockToggleReaction.mock.calls.length
    );
    ...
    console.log(
      "After menu reaction click - calls:",
      mockToggleReaction.mock.calls
    );
  ...
  test("MOBILE BUG: Reaction buttons should call toggleReaction on mobile", async () => {
    ...
    console.log(
      "Before mobile reaction click - calls:",
      mockToggleReaction.mock.calls.length
    );
    ...
    console.log(
      "After mobile reaction click - calls:",
      mockToggleReaction.mock.calls
    );
  ...
  test("Compare desktop hover bar vs menu reactions", async () => {
    ...
    const hoverThumbsBtn = hoverReactionBtns.find((btn) =>
      btn.textContent.includes("👍")
    );
