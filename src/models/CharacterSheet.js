...
export const CHARACTER_BACKGROUNDS = [
  {
    name: "Acolyte",
    description:
      "You have spent your life in service to a temple of a specific god or pantheon of gods. You act as an intermediary between the realm of the holy and the mortal world.",
  },
  {
    name: "Criminal",
    description:
  ...
  },
  {
    name: "Hermit",
    description:
      "You lived in seclusion for a formative part of your life. In your time apart from the clamor of society, you found quiet, solitude, and perhaps some of the answers you were looking for.",
  },
  {
    name: "Outlander",
    description:
 ...
 */
export function createDefaultCharacterSheet(
  name,
