...
describe("campaignService", () => {
  ...
  describe("createCampaign", () => {
    ...
    test("throws error for missing required fields", async () => {
      await expect(createCampaign(mockFirestore, {}, dmId)).rejects.toThrow(
        "Campaign name and description are required"
      );

      await expect(
        createCampaign(mockFirestore, mockCampaignData, null)
    ...
    test("handles firestore errors", async () => {
      ...
      await expect(
        createCampaign(mockFirestore, mockCampaignData, dmId)
  ...
  describe("joinCampaign", () => {
    ...
    test("handles join campaign errors", async () => {
      ...
      await expect(
        joinCampaign(mockFirestore, campaignId, userId)
  ...
  describe("searchCampaigns", () => {
    ...
    test("handles search errors", async () => {
      ...
      await expect(searchCampaigns(mockFirestore)).rejects.toThrow(
        "Network error"
      );
    });
  });
  ...
  describe("getCampaign", () => {
    ...
    test("throws error when campaign not found", async () => {
      ...
      await expect(
        getCampaign(mockFirestore, "nonexistent-id")
