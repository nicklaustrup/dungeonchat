...
function MapEditor({ campaignId, existingMap, onSave, onCancel }) {
  ...
  useEffect(() => {
    if (existingMap) {
      ...
      setGridEnabled(
        existingMap.gridEnabled !== undefined ? existingMap.gridEnabled : true
      );
    }
  }, [existingMap]);
  ...
  const handleFileUpload = async (file) => {
    ...
    try {
      ...
      if (err.code === "storage/unauthorized") {
        errorMessage =
          "Permission denied. You may not have access to upload maps for this campaign.";
  ...
  const handleSaveMap = async () => {
    ...
    try {
      ...
      if (err.code === "permission-denied") {
        errorMessage =
          "Permission denied. You must be the DM of this campaign to create maps.";
      }
        ...
        <div className="editor-main">
          <div className="canvas-section">
            ...
            <MapCanvas
              map={
                map
                  ? { ...map, gridSize, gridColor, gridOpacity, gridEnabled }
                  : null
              }
              width={canvasWidth}
              height={canvasHeight}
