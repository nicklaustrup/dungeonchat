...
const MapToolbar = ({
  ...
  const tools = [
    {
      ...
      icon: MousePointer,
      label: "Pointer",
      description: "Select mode (no drawing)",
    },
    // Ping removed - use Alt+Click to ping at any time
    {
      ...
      icon: PenTool,
      label: "Pen",
      description: "Draw temporary marks",
    },
    {
      id: "arrow",
      icon: ArrowRight,
      label: "Arrow",
      description: "Point to locations",
    },
    // Ruler and shape tools available to all players
    {
      ...
      icon: Ruler,
      label: "Ruler",
      description: "Measure distance in grid squares",
    },
    {
      id: "circle",
      icon: Circle,
      label: "Circle",
      description: "Draw circle (AOE radius)",
    },
    {
      id: "rectangle",
      icon: Square,
    ...
    },
    {
      ...
      icon: Triangle,
      label: "Cone",
      description: "Draw cone (breath / spell)",
    },
  ...
  const handleMouseDown = useCallback(
    (e) => {
      ...
      if (
        target.closest(".toolbar-control-btn") ||
        ...
        // CRITICAL: Don't drag when clicking resize handles!
        return;
      }
          ...
          <div className="toolbar-buttons">
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    if (onBoundaryBrushModeChange)
                      onBoundaryBrushModeChange("paint");
                  }}
            ...
            {isDM && (
              ...
              >
                <Shield size={20} />
                {width > 100 && (
                  <span className="toolbar-label">Boundaries</span>
                )}
              </button>
            )}
          </div>
            ...
            <>
              ...
              <div className="setting-group">
                ...
                {pinnedRulersCount > 0 && (
                  ...
                  >
                    Clear {pinnedRulersCount} Pinned Ruler
                    {pinnedRulersCount !== 1 ? "s" : ""}
                  </button>
                )}
              </div>
            </>
                ...
                <div className="color-picker-row">
                  ...
                  <div className="opacity-slider">
                    <input
                      ...
                      value={shapeOpacity}
                      onChange={(e) =>
                        onShapeOpacityChange?.(parseFloat(e.target.value))
                      }
                    />
                ...
                <div className="visibility-select">
                  <label>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        onShapeVisibilityChange?.(e.target.value)
                      }
                    >
