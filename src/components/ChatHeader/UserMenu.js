      ...
      <div className="user-menu-info-wrapper">
        <div className="user-menu-wrapper">
          ...
          >
            ...
            <span
              ref={register}
              className={`user-chip-name trunc-tooltip ${isLongUsername ? "long-username" : ""}`}
              data-full={display}
            >
              {display}
            </span>
          ...
          >
            <div className="user-menu-section user-menu-profile">
              <div className="user-menu-avatar-row">
                ...
                <div className="user-menu-names">
                  <span
                    ref={register}
                    className="user-menu-display trunc-tooltip"
                    data-full={display}
                  >
                    {display}
                  </span>
                  <span
                    ref={register}
                    className="user-menu-email trunc-tooltip"
            ...
            <div className="user-menu-section user-menu-actions">
              <button
                className="user-menu-item actionable"
