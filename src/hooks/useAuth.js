  ...
  const signInWithGithub = async () => {
    try {
      ...
      switch (error.code) {
        ...
        case "auth/operation-not-allowed":
          errorMessage =
            "GitHub sign-in is not enabled. Please contact support.";
          break;
        case "auth/account-exists-with-different-credential":
          errorMessage =
            "An account already exists with this email using a different sign-in method.";
  ...
  const signUpWithEmail = async (email, password) => {
    try {
      ...
      switch (error.code) {
        ...
        case "auth/operation-not-allowed":
          errorMessage =
            "Email/password sign-up is not enabled. Please contact support or use Google/GitHub sign-in.";
          break;
  ...
  const signInWithEmail = async (email, password) => {
    try {
      ...
      switch (error.code) {
        ...
        case "auth/operation-not-allowed":
          errorMessage =
            "Email/password sign-in is not enabled. Please contact support or use Google/GitHub sign-in.";
          break;
        case "auth/too-many-requests":
